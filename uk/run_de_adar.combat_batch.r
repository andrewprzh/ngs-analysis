    ...
    for (feature_name in c("gene", "transcript")) {
      ...
      for (experiment in c(1, 2, 4, 5)) {
        if (experiment == 1) {
          ...
          countData <- combat_counts[,c(1,2,3,16,17,18)]
        }
        if (experiment == 2) {
          exp_name = paste0("1B_vs_Ctrl.", folder)
          countData <- combat_counts[,c(4,5,6,16,17,18)]
        }
        if (experiment == 3) {
        ...
        if (experiment == 4) {
          ...
          countData <- combat_counts[,c(10,11,12,16,17,18)]
        }
        if (experiment == 5) {
          exp_name = paste0("B1A_new_vs_Ctrl.", folder)
          countData <- combat_counts[,c(13,14,15,16,17,18)]
        }
