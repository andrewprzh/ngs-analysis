...
#read data
countData = read.table("/home/andreyp/ablab/analysis/UK/Novogene.HiFi.transcript_grouped_tpm.tsv", header=TRUE, sep="\t", row.names=1 )
#countData <- countData[c(1,2,3,10,11,12)]
samples = names(countData)
head(countData)

samplesData = read.table("/home/andreyp/ablab/analysis/UK/samples_short.tsv", header=TRUE, sep="\t", row.names=1 )
head(samplesData)
