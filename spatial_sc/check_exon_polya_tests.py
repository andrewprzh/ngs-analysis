...
def process_test(polya1, polya2, exon, transcripts, strand):
    ...
    for t in transcripts:
        ...
        has_polya1 = equal_pos(polya1, polya_site, DELTA)
        has_polya2 = equal_pos(polya2, polya_site, DELTA)
...
def process_csv(inf, genedb, gene_id_dict):
    ...
    for l in open(inf):
        ...
        combination_stats[process_test(polya1, polya2, exon, transcripts, strand)] += 1
...
def main():
    ...
    print(process_csv(args.csv, genedb, gene_ids))
